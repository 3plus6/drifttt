...
driftttは、透明性の確保と改善提案を受け付けるために、ソースコードを公開する予定です。

ただし、オープンソースライセンスではありません。学習、確認、個人利用、改善提案のためにご覧いただけますが、drifttt本体、または実質的に同じアプリを第三者へ販売・有償提供・再配布することは許可していません。

詳しくは `LICENSE.md` を確認してください。

OpenAI APIキーを扱うアプリケーションのため、非公式の改変版や再配布版には注意してください。配布版は公式のGitHub Releasesからダウンロードしてください。

## 意見箱

不具合報告、改善提案、使ってみた感想はGitHub Issuesにお寄せください。すべてに対応できるとは限りませんが、今後の改善の参考にします。
